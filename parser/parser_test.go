...
func TestExpr(t *testing.T) {
	tests := []struct {
		...
		{"`abc\nxyz`", &StrLit{Raw: true, Source: "`abc\nxyz`", Data: "abc\nxyz"}},

		{`"abc\"\t\n\bxyz"`, &StrLit{Raw: false, Source: `"abc\"\t\n\bxyz"`, Data: "abc\"\t\n\bxyz"}},
		{`"\x0F"`, &StrLit{Raw: false, Source: `"\x0F"`, Data: "\x0F"}},
		{`"\u01ab"`, &StrLit{Raw: false, Source: `"\u01ab"`, Data: "\u01ab"}},
		{`"\U000065e5"`, &StrLit{Raw: false, Source: `"\U000065e5"`, Data: "\U000065e5"}},

		{`'x'`, &CharLit{Source: "'x'", Rune: 'x'}},
		{`'\\'`, &CharLit{Source: "'\\\\'", Rune: '\\'}},
		{`'\''`, &CharLit{Source: "'\\''", Rune: '\''}},
		{`'\t'`, &CharLit{Source: "'\\t'", Rune: '\t'}},
		{`'\n'`, &CharLit{Source: "'\\n'", Rune: '\n'}},
		{`'\b'`, &CharLit{Source: "'\\b'", Rune: '\b'}},
		{`'\x01'`, &CharLit{Source: "'\\x01'", Rune: '\x01'}},
		{`'\u01ab'`, &CharLit{Source: "'\\u01ab'", Rune: '\u01ab'}},
		{`'\U000065e5'`, &CharLit{Source: "'\\U000065e5'", Rune: '\U000065e5'}},
